...
public class Monster4 extends Monster{
	public Monster4(GraphicsContext gc,int h,int k,String imagepath) {
		super(gc,h,k,imagepath);
	}
	public Monster4(int hp,int atk,String imagepath,int score,int m,int c,double speedMon,double speed,GraphicsContext monsterGC) {
